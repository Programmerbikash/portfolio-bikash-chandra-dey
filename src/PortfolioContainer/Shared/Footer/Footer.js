      ...
      <footer className="footer p-10 bg-neutral text-neutral-content">
        ...
        <div>
          ...
          <div className="grid grid-flow-col gap-4">
            <a href="https://www.facebook.com/bikash.dey.96930013">
              <span>
                <GrFacebook className="w-8 h-8" />
              </span>
            </a>
            <a href="https://www.google.com/">
              <FaGooglePlusSquare className="w-8 h-8" />
            </a>
            <a href="https://www.linkedin.com/in/bikash-chandra-dey-a9a229258/">
              <FaLinkedin className="w-8 h-8" />
            </a>
            <a href="https://github.com/Programmerbikash?tab=repositories">
              <FaGithubSquare className="w-8 h-8" />
            </a>
            <a href="https://drive.google.com/file/d/1hLqZ4FfPpNZooJNPzUsNopR3r0ZaYBqQ/view?usp=sharing">
